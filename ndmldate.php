...
<meta name="description" content="NowDeals Get Member List">
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no"/>
<title>NowDeals Get Member List</title>
<link rel="stylesheet" href="styles.css">
</head>

<body>
<center>
<p class="bigtext"><strong>NowDeals<br>Get Member List</strong></p>

<p>Enter Date Range for Member List</p>
<form method="POST">
<br>
...
<br><br>
<button class="button" name="send">Get Member List</button>
</form>
<br>
...
header("Location: ndmemblist.php");
}
?>
