...
$refby = $query['refcode'];
if (!isset($refby)) { $refby = 'nowdeals'; }
$_SESSION['refby'] = $refby;
?>

<form action="ndmembsave.php" method="POST">
<br>
...
<input class="input" type="text" id="phn" name="phn" maxlength="16" size="17">
<br><br>
<label class="label" for="jdate">Join Date:</label><br>
<input class="input" type="date" id="jdate" name="jdate" maxlength="10" size="11" value=<?php echo date('Y-m-d');?> readonly>
<br><br>
<!---<label class="label" for="rcode">Referral Code:</label><br>
<input class="input" type="text" id="rcode" name="rcode" maxlength="10" size="11" value=<?php echo $refby;?> disabled>
<br><br>--->
...
<br><br>
<label class="label" for="act">Vendor?</label><br>
...
<textarea class="textarea" id="radd" name="radd" rows="2" cols="40" maxlength="60"></textarea>
<br><br>
