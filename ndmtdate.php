...
<meta name="description" content="NowDeals Send DEALS Tokens">
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no"/>
<title>NowDeals Send DEALS Tokens</title>
<link rel="stylesheet" href="styles.css">
</head>

<body>
<center>
<p class="bigtext"><strong>NowDeals<br>Send DEALS Tokens</strong></p>

<p>Enter Date Range for Sending DEALS Tokens</p>
<form method="POST">
<br>
...
<br><br>
<button class="button" name="send">Send Tokens</button>
<br>
...
header("Location: ndmsdealst.php");
}
?>
